...
const serverRender = async (ctx: ISSRContext, config: IConfig) => {
  const { mode, parallelFetch, prefix, isVite, isDev, clientPrefix, stream, onError, onReady } =
    config
    ...
    const injectScript = [
      ...
      ...(isVite && isDev
        ? [
            <script
              type="module"
              src="/node_modules/ssr-plugin-react18/esm/entry/client-entry.js"
